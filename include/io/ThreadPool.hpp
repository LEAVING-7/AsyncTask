...
public:
  ...
  auto task_total() -> size_t { return tasks_total; }
  // =======================
   ...
   * running in the threads and those that are still waiting in the queue. Note: To wait for just one specific task, use
